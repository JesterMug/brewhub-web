...
<header>
    ...
    <div class="container px-4 px-lg-5 my-4">
        <div class="text-center text-white">
            ...
            <p class="lead">Update your shipping address</p>
        </div>
    </div>
</header>
                ...
                <div class="card-body">
                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            ...
                            <?= $this->Form->text('label', ['class' => 'form-control', 'maxlength' => 63]) ?>
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-12">
                            ...
                            <?= $this->Form->text('street', ['class' => 'form-control', 'required' => true, 'maxlength' => 255]) ?>
                        </div>
                        <div class="col-md-6">
                    ...
                    <div class="d-flex gap-2 mt-4">
                        <a href="<?= $this->Url->build(['controller' => 'Profile', 'action' => 'addresses']) ?>" class="btn btn-outline-secondary">Back</a>
